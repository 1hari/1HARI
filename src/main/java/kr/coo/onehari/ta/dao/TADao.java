...
public interface TADao {
    ...
    //이번달 퇴근기록 yyyy-mm-dd 오형남 / 2020. 1. 14
    public List<String> getEndListCal(int empNum, String calYear, String calMonth) throws ClassNotFoundException, SQLException;
    
    //이번달 결근기록 yyyy-mm-dd 오형남 / 2020. 1. 14
    public List<String> getAbsentListCal(int empNum, String calYear, String calMonth) throws ClassNotFoundException, SQLException;
    
    //이번달 연차기록 yyyy-mm-dd 오형남 / 2020. 1. 14
    public List<String> getAnntListCal(int empNum, String calYear, String calMonth) throws ClassNotFoundException, SQLException;
    ...
    public Integer getWork(int empNum, int year) throws ClassNotFoundException, SQLException;
    
    //형남 0121 지각 횟수 가져오기(사원 대시보드 차트)
    public Integer getTardy(int empNum, int year) throws ClassNotFoundException, SQLException;
    
    //형남 0121 결근 횟수 가져오기(사원 대시보드 차트)
    public Integer getAbsent(int empNum, int year) throws ClassNotFoundException, SQLException;
