...
<div class="page-wrapper">
	...
	<div class="container-fluid" style ="margin-top: 3%;">
		...
		<div class="row">
			<div class="col-12">
				<!--내 문서함 테이블 -->
				<div class="card"  style=" box-shadow :7px 7px #505050; border-radius:10px;">
					<div class="card-body">
						<div class="row">
							<!-- 문서구분 버튼 -->
							<div class="col-md-6">
...
// 			});
	...
	function page(code,pg,signDate, signNum, signTitle, draftEmp, searchKey){
		$.ajax({
			url:"${pageContext.request.contextPath}/ajax/signAdminPage.hari",
			type:"post",
			data :{
				"code" : code,
				"signDate" : signDate,
...
// 			}
	...
	function list(code, cp, pg, signDate, signNum, signTitle, draftEmp, searchKey){
		...
		$.ajax({
			url:"${pageContext.request.contextPath}/ajax/selectSignAdmin.hari",
			type:"post",
			data :{
					"code" : code,
					"cp" : cp,
